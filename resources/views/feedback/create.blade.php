...
<main class="form-signin">
    <form method="post" action="{{ route('feedback.store') }}">
        ...
        <div class="form-floating">
            <input type="text" class="form-control" id="floatingName"  name="nickName" placeholder="Иван Иванов">
            <label for="floatingName">Ваше имя</label>
        </div>
        <div class="form-floating">
            <textarea type="text" class="form-control" id="floatingFeedback" placeholder="Password"
                      rows="5" style="height: auto" name="content"></textarea>
